            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead><tr className="border-b text-left text-muted-foreground text-xs uppercase tracking-wider">
                  <th className="p-3 font-medium">Nome</th><th className="p-3 font-medium">Empresa</th><th className="p-3 font-medium">Status</th><th className="p-3 font-medium w-20">Ações</th>
                </tr></thead>
                <tbody>
