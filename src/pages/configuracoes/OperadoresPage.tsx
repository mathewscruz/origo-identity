            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead><tr className="border-b text-left text-muted-foreground">
                  <th className="pb-2 font-medium">Nome</th><th className="pb-2 font-medium hidden md:table-cell">Email</th><th className="pb-2 font-medium">Status</th><th className="pb-2 font-medium w-20">Ações</th>
                </tr></thead>
                <tbody>
                  {paginatedItems.map((op: any) => (
                    <tr key={op.id} className="border-b last:border-0 hover:bg-muted/50">
                      ...
                      <td className="py-3 text-muted-foreground hidden md:table-cell">{op.email}</td>
